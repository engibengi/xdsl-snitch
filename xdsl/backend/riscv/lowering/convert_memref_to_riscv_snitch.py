...
from xdsl.dialects import memref, riscv, riscv_func, riscv_snitch
...
class ConvertMemrefStoreOp(RewritePattern):
    ...
    def match_and_rewrite(self, op: memref.Store, rewriter: PatternRewriter):
        ...
        result_register_type = register_type_for_type(op.value.type)
    ...
    def match_and_rewrite(self, op: memref.Global, rewriter: PatternRewriter):
        ...
        match element_type:
            ...
            case Float32Type() | Float64Type():
                # Already handled in convert_memref_to_riscv, but kept just in case
                return
            case _:
                # Already handled in convert_memref_to_riscv, but kept just in case
                return
...
# Should not need you two as long as convert_memref_to_riscv does this
#
...
class ConvertMemrefToRiscvSnitchPass(ModulePass):
    name = "convert-memref-to-riscv-snitch"
